...
const cmds = {
	info: msg => sendmessage(msg.channel, `I'm prettify-bot, a bot that can prettify your code and upload it to hastebin for you.
...
Find out more about things I can do: <https://github.com/iagrib/prettify-bot/blob/master/info.md>`, msg.author),
	...
	code: msg => sendmessage(msg.channel, `Codeblocks:
\\\`\\\`\\\`lang
code...\\\`\\\`\\\`
...
// code goes here...\`\`\``, msg.author),
	...
	source: msg => sendmessage(msg.channel, `https://github.com/iagrib/prettify-bot`, msg.author)
}
